<template>
    <div class="admin-menu">
        <wrapper>
            ...
            <Table :columns="columns" :dataSource="data" :pagination="false" defaultExpandAllRows rowKey="node"
                   v-if="data.length">
                ...
                <template slot="action" slot-scope="text,record,index">
                    <div v-if="record.node.indexOf('/') !== -1">
                        <span style="margin-left: 24px;" v-if="!record.children && record.pnode"></span>

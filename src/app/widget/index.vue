...
<script>
    ...
    import HeaderNotice from '../exports/layout/header/HeaderNotice';
    import HeaderAvatar from '../exports/layout/header/HeaderAvatar';
    import HeaderSelect from '../exports/layout/header/HeaderSelect';
    import VUploader from '../exports/tools/VUploader';
    import Socket from '../exports/websocket/socket';
    import config from '../frames/config';

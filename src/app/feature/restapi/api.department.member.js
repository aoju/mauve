...
export function searchInviteMember(keyword, departmentCode) {
    return $http.post('project/department_member/searchInviteMember', {
        'keyword': keyword,
...
export function inviteMember(accountCode, departmentCode) {
    return $http.post('project/department_member/inviteMember', {
...
export function removeMember(accountCode, departmentCode) {
    return $http.post('project/department_member/removeMember', {
        'accountCode': accountCode,
        'departmentCode': departmentCode
    });
}

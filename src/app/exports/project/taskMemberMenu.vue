<template>
    <div class="member-menu">
        <a-spin :spinning="listLoading || doListLoading">
            ...
            <div class="member-list">
                <vue-scroll>
                    <div class="list-group" v-show="!keyword">
                        ...
                        <div @click="assignTask(null)" class="member-list-item ant-list-item"
                    ...
                    <div class="list-group">
                        ...
                        <div @click="assignTask(null)" class="member-list-item ant-list-item" v-if="doList.length">
                            <div class="ant-list-item-meta">
                                <div class="ant-list-item-meta-avatar">
                                    <a-avatar icon="user"></a-avatar>
                                </div>
                        ...
                        <a-list
                                ...
                                itemLayout="horizontal"
                        >
                            <a-list-item @click.native="assignTask(item.code,item)"
            ...
            <div class="footer">
                <a-button @click="inviteProjectMember" block size="large" type="primary">邀请新成员</a-button>
            </div>
        </a-spin>
    </div>
</template>
...
<script>
    ...
    import {list} from '../../frames/restapi/projectMember';
    import {list as getTaskMembers} from '../../frames/restapi/taskMember';
    import {assignTask} from '../../frames/restapi/task';

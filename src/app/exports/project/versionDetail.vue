<template>
    <div class="version-detail">
        <a-spin :spinning="loading" class="version-detail-spin">
                ...
                <div class="task-content">
                    <div class="content-left">
                        <vue-scroll :ops="scrollOps">
                            <div :class="{'disabled': disableEdit}" class="task-title">
                                <a-input @blur="doName" auto-focus ref="inputTitle" size="large" v-model="version.name"
                                         v-show="showEditName"/>
                            ...
                            <div class="task-basic-attrs-view muted">
                                <div :class="{'disabled': disableEdit}" class="field-list">
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-right">
                                                <a-dropdown
                                                    ...
                                                    <a-tooltip placement="top">
                                                        <template slot="title">
                                                            <span style="font-size: 12px;"
                                                                  v-if="disableEdit">版本已发布，不能编辑</span>
                                                        </template>
                                                        <span>
                                                            <span :class="`status-${version.status}`"
                                                    ...
                                                    <a-menu :selectable="false" @click="changeVersionStatus"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            ...
                                            <div class="field-right field-date">
                                                <a-dropdown :disabled="disableEdit" :trigger="['click']"
                                                    ...
                                                    <div slot="overlay">
                                                        ...
                                                        >
                                                            <template slot="renderExtraFooter">
                                                                <a @click="doStartTime(false)" size="small"
                                            ...
                                            <div class="field-right field-date">
                                                <a-dropdown :disabled="disableEdit" :trigger="['click']"
                                                    ...
                                                    <div slot="overlay">
                                                        ...
                                                        >
                                                            <template slot="renderExtraFooter">
                                                                <a @click="doPlanPublishTime(false)" size="small"
                                                                   style="position: absolute;">清除</a>
                                                            </template>
                                                        </a-date-picker>
                                                    </div>
                                        ...
                                        <div class="field">
                                            ...
                                            <div class="field-right width-block">
                                                <a-tooltip :mouseEnterDelay="0.3"
                                                           ...
                                                           placement="top">
                                                    <a-progress :percent="version.schedule"
                                                                :strokeWidth="4"/>
                                                </a-tooltip>
                                            </div>
                                        </div>
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            ...
                                            <div class="field-right width-block">
                                                <div :class="{'disabled': disableEdit}" @click="showVersionDesc"
                                                     class="task-description"
                                                     v-show="!showVersionDescriptionEdit">
                                                    <div class="description-txt" v-html="version.description"
                                                         v-show="version.description"></div>
                                                ...
                                                <div v-show="showVersionDescriptionEdit">
                                                    ...
                                                    <div class="action-btn pull-right">
                                                        <a @click="showVersionDescriptionEdit = false"
                                    ...
                                    <div class="component-mount">
                                        <div class="field">
                                            <div class="field-left">
                                                <a-icon type="bars"/>
                                                <span class="field-name">发布内容 <span
                                                        v-show="versionTaskSchedule !== false"> · {{versionTaskDoneNum}}/{{versionTaskList.length}}</span></span>
                                            </div>
                                            <div class="field-right width-block">
                                            </div>
                                        </div>
                                                        ...
                                                        <div :key="versionTask.code"
                                                            ...
                                                            <div class="list-item task">
                                                                ...
                                                                <span class="m-r muted">
                                                                    <span class="text-success" v-if="versionTask.done">已完成</span>
                                                                    <span v-else>未完成</span>
                                                                </span>
                                                                <a @click.stop="removeVersionTask(versionTask)"
                                                                   class="muted">
                        ...
                        <div class="log-wrap">
                            ...
                            <vue-scroll>
                                <div class="log-list muted">
                                    <a @click="getMoreVersionLog" class="show-more muted"
                                       v-show="checkShowMoreLog">
                                        <a-icon type="ellipsis"/>
                                        显示较早的 {{versionLogTotal - versionLog.length}} 条动态
                                    </a>
                                    <div :key="log.code"
                                         class="list-item" v-for="log in versionLog">
                                        <template>
        ...
        >
            ...
            <vue-scroll>
                <div class="publish-task">
                    <a-checkbox-group v-model="publishTask.selectTaskList">
                        <div :key="stageIndex" class="m-b" v-for="(taskStages, stageIndex) in publishTask.taskStages">
                            ...
                            >
                                <a-list-item slot="renderItem" slot-scope="task,index">
                                    <a-list-item-meta
                                    >
                                        <div :class="{'muted': task.version_code}" slot="title">
                                            {{task.name}}
                                        </div>
                                        <div slot="avatar">
            ...
            <div class="footer-item text-right m-t">
                <a-button @click="addVersionTask" class="middle-btn" size="large" type="primary">保存</a-button>
            </div>
        </a-modal>
        <a-modal
                :closable="false"
...
<script>
    ...
    } from '@/app/frames/restapi/projectVersion';
    import {relativelyTaskTime, relativelyTime} from '@/assets/js/dateTime';
    import {checkResponse} from '../../../assets/js/utils';
    import {addVersionTask, changeStatus, removeVersionTask} from '../../frames/restapi/projectVersion';
    import {list as getTaskStages, tasks as getTasks} from '../../frames/restapi/taskStages';

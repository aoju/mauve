            ...
            <div class="config-content">
                    ...
                    <div class="infos">
                        ...
                        <div class="cover-item">
                            <template v-if="project.cover">
                                <img :src="project.cover" class="avatar"/>
                            </template>
                            ...
                            <a-upload
                                    ...
                                    name="cover"
                            >
                                <a-button class="upload" size="large">上传新封面</a-button>
                ...
                <div class="content-item">
                    <div class="infos">
                        ...
                        <a-input :rows="3" placeholder="介绍一下这个项目" size="large" type="textarea"
                ...
                <div class="content-item">
                    <div class="infos">
                        <a-button @click="saveProject" class="middle-btn pull-right" size="large"
                                  type="primary">
                            保存
                        </a-button>
                    </div>
                ...
                <div class="content-item">
                    <div class="infos">
                        ...
                        <a-button :disabled="!project.open_prefix" @click="saveProject" class="middle-btn"
                                  size="large" type="primary">保存
                        </a-button>
                    </div>
                    <a-switch @change="saveProject" v-model="project.open_prefix"/>
                </div>
                <div class="content-item">
                    <div class="infos">
                    ...
                    <a-switch @change="saveProject" v-model="project.open_begin_time"/>
                </div>
                <div class="content-item">
                    <div class="infos">
                    ...
                    <a-switch @change="saveProject" v-model="project.open_task_private"/>
                </div>
            </div>
        </a-tab-pane>
        <a-tab-pane forceRender key="4">
             <span slot="tab">
                ...
                <div class="content-item task-workflow">
                    <div class="infos" style="padding-right: 0">
                        <div v-show="!doTaskWorkflowView">
                            <p>
                                <a-button @click="doTaskWorkflow(null)" icon="plus" type="primary">创建规则</a-button>
                            </p>
                            <a-list
                            ...
                            >
                                ...
                                <span slot="actions">
                                     <a-tooltip placement="top"
                                                title="编辑">
                                        <a @click="doTaskWorkflow(item)" class="muted m-r-sm"><a-icon
                                                type="edit"></a-icon></a>
                                    </a-tooltip>
                                     <a-tooltip placement="top"
                                                title="删除">
                                         <a @click="delTaskWorkflow(item.code)" class="muted">
                        ...
                        <div v-show="doTaskWorkflowView">
                            <div class="header">
                                <p>
                                    <a-button @click="saveTaskWorkflow(false)" class="middle-btn m-r-sm" size="large">
                                        取消
                                    </a-button>
                                    <a-button :disabled="!canSaveTaskWorkflow" @click="saveTaskWorkflow(true)"
                                              class="middle-btn"
                                              size="large" type="primary">保存
                                    </a-button>
                                </p>
                            ...
                            <div class="workflow-content">
                                <template v-if="!loadingWorkflowRule">
                                    <div class="workflow-rule-item">
                                        ...
                                        <a-input size="large"
                                                 v-model="currentTaskWorkflowRule.taskWorkflowName"></a-input>
                                    </div>
                                    <div class="workflow-rule-item">
                                        <p>选择任务列表</p>
                                        <a-select @change="(value)=>workflowRuleChange(value,'firstObj')" size="large"
                                                  v-model="currentTaskWorkflowRule.firstObj">
                                            <a-select-option :key="taskStage.code"
                                    ...
                                    <template v-if="currentTaskWorkflowRule.firstObj">
                                        <div class="workflow-rule-item">
                                            <p>选择条件</p>
                                            <a-select @change="(value)=>workflowRuleChange(value,'firstAction.action')"
                                                      size="large"
                                                      v-model="currentTaskWorkflowRule.firstAction.action">
                                                <a-select-option :key="rule.id"
                                                                 :value="rule.id"
                                            ...
                                            <template v-if="currentTaskWorkflowRule.firstAction.action == 3">
                                                <div class="workflow-rule-item">
                                                    ...
                                                    <a-select
                                                        ...
                                                        <a-select-option :key="member.code"
                                                                         :value="member.code"
            ...
            <div class="config-content more-config">
                <div class="content-item">
                    <div class="infos">
                        ...
                        <a-button @click="archiveProject" class="middle-btn" size="large">
                            <span v-if="project.archive">取消归档</span>
                            <span v-if="!project.archive">归档项目</span>
                        </a-button>
                        <a-button @click="quitProject" class="middle-btn" size="large">退出</a-button>
                        <a-button @click="delProject" class="middle-btn" size="large" type="danger">
...
<script>
    ...
    } from '../../frames/restapi/taskWorkflow';
    import {_getAll as getTaskStages} from '../../frames/restapi/taskStages';
    import {list as getProjectMembers} from '../../frames/restapi/projectMember';
    ...
    export default {
        ...
        'computed': {
            ...
            canSaveTaskWorkflow() {
                return this.currentTaskWorkflowRule.taskWorkflowName.trim()
